/**
 * WIKSHOP
 * 版权所有: 2010-2011 台湾协霆资讯有限公司，并保留所有权利。
 * 官方网站: http://www.wikshop.com
 ==============================================================================
 * 声明: 这不是一个自由软件！您只能在不用于商业目的的前提下对程序代码进行修改和
...
Popup.prototype = {
    ...
    build: function() {
        ...
        var path = "/Public/dialogclose.gif";
        var close = '<input type="image" id="dialogBoxClose" src="' + path + '" border="0"   align="absmiddle" title="关闭" style="display:block"/>';
    ...
    lastBuild: function() {
        ...
        if (this.config.contentType == 1) {
            var openIframe = "<iframe width='100%' style='height:" + this.config.height + "px;overflow:scroll;overflow-x:hidden;"+(this.config.yscoll==0?'overflow-y:hidden;':'')+"' name='" + this.iframeIdName + "' id='" + this.iframeIdName + "' src='" + this.info.contentUrl + "' frameborder='0' scrolling='" + this.config.scrollType + "'></iframe>";
    ...
    reset: function() {
        ...
        window.location.href = this.info.lianjie;
		};
        this.close()
    },
    close: function() {
