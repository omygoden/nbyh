...
dsy.add("0_30", ["乌鲁木齐", "克拉玛依", "自治区直辖县级行政单位", "喀什", "阿克苏", "和田", "吐鲁番", "哈密", "克孜勒苏柯", "博尔塔拉", "昌吉", "巴音郭楞", "伊犁", "塔城", "阿勒泰"]);
...
var opt1 = ["省份", "地级市", "市、县级市"];
var opt2 = ["省份", "地级市", "市、县级市"];
function _init_area(a, b, c) {
    ...
    if (dsy.Exists(str)) {
        ...
        for (i = 0; i < ar.length; i++) {
            if (ar[i] == a) {
                sheng = i;
                document.getElementById('s_province').options[i + 1].selected = true;
                str += ("_" + sheng);
                changenano(1);
                break;
            }
        ...
        for (j = 0; j < br.length; j++) {
            if (br[j] == b) {
                shi = j;
                document.getElementById('s_city').options[j + 1].selected = true;
                str += ("_" + shi);
                changenano(2);
                break;
            }
        ...
        for (k = 0; k < cr.length; k++) {
            if (cr[k] == c) {
                qu = k;
                document.getElementById('s_county').options[k + 1].selected = true;
                str += ("_" + qu);
                break;
            }
        }
...
function _init_area1(a, b, c) {
    ...
    if (dsy.Exists(str)) {
        ...
        for (i = 0; i < ar.length; i++) {
            if (ar[i] == a) {
                sheng = i;
                document.getElementById('s_province1').options[i + 1].selected = true;
                str += ("_" + sheng);
                changenano1(1);
                break;
            }
        ...
        for (j = 0; j < br.length; j++) {
            if (br[j] == b) {
                shi = j;
                document.getElementById('s_city1').options[j + 1].selected = true;
                str += ("_" + shi);
                changenano1(2);
                break;
            }
        ...
        for (k = 0; k < cr.length; k++) {
            if (cr[k] == c) {
                qu = k;
                document.getElementById('s_county1').options[k + 1].selected = true;
                str += ("_" + qu);
                break;
            }
        }
...
function _init_area2(a, b, c) {
    for (i = 0; i < s2.length - 1; i++) {
        document.getElementById(s2[i]).onchange = new Function("chan(" + (i + 1) + ")");
    }
    chan(0);
    var sheng = null;
    var shi = null;
    ...
    if (dsy.Exists(str)) {
        ...
        for (i = 0; i < ar.length; i++) {
            if (ar[i] == a) {
                sheng = i;
                document.getElementById('s_province2').options[i + 1].selected = true;
                str += ("_" + sheng);
                changenano2(1);
                break;
            }
        ...
        for (j = 0; j < br.length; j++) {
            if (br[j] == b) {
                shi = j;
                document.getElementById('s_city2').options[j + 1].selected = true;
                str += ("_" + shi);
                changenano2(2);
                break;
            }
        ...
        for (k = 0; k < cr.length; k++) {
            if (cr[k] == c) {
                qu = k;
                document.getElementById('s_county2').options[k + 1].selected = true;
                str += ("_" + qu);
                break;
            }
        }
...
function _init_area3(a, b, c) {
    for (i = 0; i < s3.length - 1; i++) {
        document.getElementById(s3[i]).onchange = new Function("changg(" + (i + 1) + ")");
    }
    changg(0);
    var sheng = null;
    var shi = null;
    ...
    if (dsy.Exists(str)) {
        ...
        for (i = 0; i < ar.length; i++) {
            if (ar[i] == a) {
                sheng = i;
                document.getElementById('s_province3').options[i + 1].selected = true;
                str += ("_" + sheng);
                changenano3(1);
                break;
            }
        ...
        for (j = 0; j < br.length; j++) {
            if (br[j] == b) {
                shi = j;
                document.getElementById('s_city3').options[j + 1].selected = true;
                str += ("_" + shi);
                changenano3(2);
                break;
            }
        ...
        for (k = 0; k < cr.length; k++) {
            if (cr[k] == c) {
                qu = k;
                document.getElementById('s_county3').options[k + 1].selected = true;
                str += ("_" + qu);
                break;
            }
        }
