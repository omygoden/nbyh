                ...
                if(arrayInfor.length>0) {
                    ...
                    if (zuheDate.length > 0) {
                        ...
                        $.each(zuheDate, function (index, item) {
                            ...
                            var td1 = $("<td ><input name=\"Txt_PriceSon\" id=" + item + "  class=\"l-text\" type=\"text\" value=" + price + " ></td>");
                            td1.appendTo(tr);

                            var td2 = $("<td ><input name=\"Txt_CountSon\" id=" + item + " class=\"l-text\" type=\"text\" value=" + stocl + " ></td>");
                            td2.appendTo(tr);
