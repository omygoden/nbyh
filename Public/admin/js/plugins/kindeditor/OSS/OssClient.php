<?php
include('Core/MimeTypes.php');
include('Core/OssException.php');
include('Http/RequestCore.php');
include('Http/RequestCore_Exception.php');
include('Http/ResponseCore.php');
include('Model/CorsConfig.php');
include('Model/CnameConfig.php');
include('Model/LoggingConfig.php');
include('Result/AclResult.php');
include('Result/BodyResult.php');
include('Result/GetCorsResult.php');
include('Result/GetLifecycleResult.php');
include('Result/GetLoggingResult.php');
include('Result/GetRefererResult.php');
include('Result/GetWebsiteResult.php');
include('Result/GetCnameResult.php');
include('Result/HeaderResult.php');
include('Result/InitiateMultipartUploadResult.php');
include('Result/ListBucketsResult.php');
include('Result/ListMultipartUploadResult.php');
include('Model/ListMultipartUploadInfo.php');
include('Result/ListObjectsResult.php');
include('Result/ListPartsResult.php');
include('Result/PutSetDeleteResult.php');
include('Result/ExistResult.php');
include('Model/ObjectListInfo.php');
include('Result/UploadPartResult.php');
include('Model/BucketListInfo.php');
include('Model/LifecycleConfig.php');
include('Model/RefererConfig.php');
include('Model/WebsiteConfig.php');
include('Core/OssUtil.php');
include('Model/ListPartsInfo.php');
