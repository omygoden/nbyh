        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <!--<form type="get" enctype="multipart/form-data" action="/indexadm.php/usercheck/apply_distribution_check">-->
                    ...
                    <div class="col-sm-12" style="margin-bottom: 1rem">
                        <form role="form" action="/indexadm.php/usercheck/apply_distribution_check" method="get">
                            ...
                            <th class="">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="/indexadm.php/Usercheck/apply_distribution_check">全部</a></li>
                                        <li><a href="/indexadm.php/Usercheck/apply_distribution_check/status/0">待审核</a></li>
                                        <li><a href="/indexadm.php/Usercheck/apply_distribution_check/status/2">已驳回</a></li>
                                    </ul>
                                </div>
                            </th>
...
//        console.log(opinion+openid+status);

        $.post('/indexadm.php/Usercheck/sub_distribution_check',{opinion:opinion,openid:openid,status:status},function(data){
//            console.log(data);
            if(data.code=='1001'){
