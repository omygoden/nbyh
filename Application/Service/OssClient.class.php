...
use Service\Core\MimeTypes;
use Service\Core\OssException;
use Service\Http\RequestCore;
use Service\Http\RequestCore_Exception;
use Service\Http\ResponseCore;
use Service\Model\CorsConfig;
use Service\Model\CnameConfig;
use Service\Model\LoggingConfig;
use Service\Result\AclResult;
use Service\Result\BodyResult;
use Service\Result\GetCorsResult;
use Service\Result\GetLifecycleResult;
use Service\Result\GetLoggingResult;
use Service\Result\GetRefererResult;
use Service\Result\GetWebsiteResult;
use Service\Result\GetCnameResult;
use Service\Result\HeaderResult;
use Service\Result\InitiateMultipartUploadResult;
use Service\Result\ListBucketsResult;
use Service\Result\ListMultipartUploadResult;
use Service\Model\ListMultipartUploadInfo;
use Service\Result\ListObjectsResult;
use Service\Result\ListPartsResult;
use Service\Result\PutSetDeleteResult;
use Service\Result\ExistResult;
use Service\Model\ObjectListInfo;
use Service\Result\UploadPartResult;
use Service\Model\BucketListInfo;
use Service\Model\LifecycleConfig;
use Service\Model\RefererConfig;
use Service\Model\WebsiteConfig;
use Service\Core\OssUtil;
use Service\Model\ListPartsInfo;
...
class OssClient
{
     ...
     * @throws OssException
     */
    public function __construct($accessKeyId, $accessKeySecret, $endpoint , $isCName = true, $securityToken = NULL)
    {
